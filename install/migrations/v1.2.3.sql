-- v1.2.3: Repair schema additions skipped by the v1.2.0/v1.2.2 migration runner bug.
-- Safe to run on any install: runner now swallows duplicate-column and table-exists errors.
