-- v1.2.2: Repair — re-apply v1.2.0 schema additions
-- The migration runner now swallows duplicate-column and table-exists errors,
-- so this is a no-op if v1.2.0 ran correctly, and a full repair if it was skipped.

ALTER TABLE contacts ADD COLUMN engagement_score TINYINT UNSIGNED DEFAULT NULL;
ALTER TABLE contacts ADD COLUMN engagement_score_at DATETIME DEFAULT NULL;
